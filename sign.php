...
<body>
	...
	<form method="post" action="register.php"
		style="border:1px solid black; ;margin-top: 100px; margin-right: 30px; margin-left: 30px;">
		<div style="padding-top: 20px; padding-bottom: 20px; padding-left: 50px; padding-right: 50px;">
			...
			<div class="input-group">
				<button style="font-size: 15px;" type="submit" class="btn" name="reg_user">Kayıt ol</button>
			</div>

			<p>
				Üyeliğiniz varsa <a href="login.php">buradan giriş yapın.</a>
			</p>
		</div>
	</form>
