<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $mypassword = mysqli_real_escape_string($baglan,$_POST['password']); 
      
      $sql = "SELECT durum FROM uye_bilgileri WHERE mail = '$mail' and password = '$mypassword'";
...
<body>
   ...
   <form action="" style="border:1px solid black; ;margin-top: 100px; margin-right: 30px; margin-left: 30px;"
      ...
      <div style="padding-top: 20px; padding-bottom: 20px; padding-left: 50px; padding-right: 50px;">
         ...
         <div class="input-group">
            <button style="font-size: 15px;" type="submit" class="btn" name="sign_user">Giriş yap</button>
         </div>
